...
int main (int argc, char *argv[]) {
        ...
        multMatMatV2(mRow_1, mRow_2, n, resMat2);
        ...
        printf("Tempo matriz vetor: %lf\nTempo matriz vetor otimizado: %lf\n", tempoMatVet, tempoMatVetV2);
        printf("Tempo matriz matriz: %lf\nTempo matriz matriz otimizado: %lf\n", tempoMatMat, tempoMatMatV2);
        liberaVetor((void*) mRow_1);
        liberaVetor((void*) mRow_2);
        liberaVetor((void*) resMat);
        liberaVetor((void*) resMat2);
